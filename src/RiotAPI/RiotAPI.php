...
class RiotAPI
{
    ...
    const // Set internally by setting region
        SET_KEY = 'SET_KEY';
    const // API key used by default
        SET_TOURNAMENT_KEY = 'SET_TOURNAMENT_KEY';
    const // API key used when working with tournaments
        SET_TOURNAMENT_INTERIM = 'SET_TOURNAMENT_INTERIM';
    const // Used to set whether your application is in Interim mode (Tournament STUB endpoints) or not,
        SET_CACHE_PROVIDER = 'SET_CACHE_PROVIDER';
    const // Specifies CacheProvider class name
        SET_CACHE_PROVIDER_PARAMS = 'SET_CACHE_PROVIDER_PARAMS';
    const // Specifies parameters passed to CacheProvider class when initializing
        SET_CACHE_RATELIMIT = 'SET_CACHE_RATELIMIT';
    const // Used to set whether or not to save and check API key's rate limit
        SET_RATELIMITS = 'SET_RATELIMITS';
    const // Specifies limits for provided API keys
        SET_CACHE_CALLS = 'SET_CACHE_CALLS';
    const // Used to set whether or not to temporary save API call's results
        SET_CACHE_CALLS_LENGTH = 'SET_CACHE_CALLS_LENGTH';
    const // Specifies for how long are call results saved
        SET_API_BASEURL = 'SET_API_BASEURL';
    const SET_USE_DUMMY_DATA = 'SET_USE_DUMMY_DATA';

    const
        CACHE_PROVIDER_FILE = FileCacheProvider::class;
    const CACHE_PROVIDER_MEMCACHED = MemcachedCacheProvider::class;
