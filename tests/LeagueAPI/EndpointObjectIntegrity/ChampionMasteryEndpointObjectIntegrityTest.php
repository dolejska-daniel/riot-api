...
class ChampionMasteryEndpointObjectIntegrityTest extends RiotAPITestCase
{
	 ...
	 * @param LeagueAPI $api
	 */
	public function testGetChampionMastery(LeagueAPI $api )
	{
	 ...
	 * @param LeagueAPI $api
	 */
	public function testGetChampionMasteries(LeagueAPI $api )
	{
		$summonerId = "KnNZNuEVZ5rZry3IyWwYSVuikRe0y3qTWSkr1wxcmV5CLJ8";
		//  Get library processed results
		/** @var Objects\ChampionMasteryDto[] $result */
	 ...
	 * @param LeagueAPI $api
	 */
	public function testGetChampionMasteryScore(LeagueAPI $api )
	{
		$summonerId = "KnNZNuEVZ5rZry3IyWwYSVuikRe0y3qTWSkr1wxcmV5CLJ8";
		//  Get library processed results
		/** @var Objects\ChampionMasteryDto $result */
