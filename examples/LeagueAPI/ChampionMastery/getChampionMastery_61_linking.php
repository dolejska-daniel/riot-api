...
$m = $custom_api->getChampionMastery($summoner->id, $id);
...
<html>
	...
	<body class="container">
		<p class="lead">Fetching mastery data for summoner with SummonerID: <code><?=$summoner?></code> and champion with ChampionID: <code><?=$id?></code>. Using <b>StaticData linking</b> feature.</p>
